...
for filename in ('editor-test-data.js','editor-browser-fixture.js'): shutil.copy2(root/'tests'/filename,out/filename)
...
html=html.replace('</body>','<script src="editor-browser-fixture.js"></script></body>')
