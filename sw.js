...
async function withAppExtensions(response){
  ...
  html=html.replace('</body>','<script src="calendar-controller.js?v=9"></script><script src="calendar-toolbar.js?v=1"></script><script src="settings-icon.js?v=2"></script><script src="warehouse-categories.js?v=1"></script></body>');
