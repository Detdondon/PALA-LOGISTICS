const CACHE='pala-v158-hide-pack-completed';
const CORE=['./fonts/inter-400.ttf','./fonts/inter-700.ttf','./','./index.html','./workshop-edit.js?v=3','./calendar-controller.js?v=8','./Logo.png','./manifest.webmanifest?v=110','./pala-icon.svg?v=110','./pala-icon-32.png?v=110','./pala-icon-180.png?v=110','./pala-icon-192.png?v=110','./pala-icon-512.png?v=110'];
...
async function withAppExtensions(response){
  ...
  html=html.replace(/<script\s+src=["']calendar-controller\.js[^"']*["']><\/script>/gi,'');html=html.replace('</body>','<script src="calendar-controller.js?v=8"></script></body>');
