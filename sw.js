const CACHE='pala-v151-compact-calendar-list';
const CORE=['./fonts/inter-400.ttf','./fonts/inter-700.ttf','./','./index.html','./workshop-edit.js?v=1','./calendar-controller.js?v=2','./Logo.png','./manifest.webmanifest?v=110','./pala-icon.svg?v=110','./pala-icon-32.png?v=110','./pala-icon-180.png?v=110','./pala-icon-192.png?v=110','./pala-icon-512.png?v=110'];
...
async function withAppExtensions(response){
  ...
  if(!html.includes('calendar-controller.js'))html=html.replace('</body>','<script src="calendar-controller.js?v=2"></script></body>');
