...
if(!document.getElementById('pala-warehouse-categories-v183-style')){
  const style=document.createElement('style');style.id='pala-warehouse-categories-v183-style';style.textContent=`
    ...
    .warehouse-move-list-v183{max-height:48vh;overflow:auto;border:1px solid #dfe5ed;border-radius:11px;padding:5px;margin:8px 0 12px}.warehouse-move-row-v183{display:flex;gap:9px;align-items:flex-start;padding:8px;border-radius:8px;cursor:pointer}.warehouse-move-row-v183:hover{background:#f6f8fb}.warehouse-move-row-v183 input{margin-top:3px}.warehouse-move-row-v183 span{display:grid}.warehouse-move-row-v183 small{color:#748094}
    ...
    @media(max-width:760px){.warehouse-manager-grid-v183{grid-template-columns:1fr}.warehouse-structure-actions-v183{width:100%}.warehouse-structure-actions-v183 .btn{flex:1}.warehouse-category-v183>summary{padding:12px 11px}.warehouse-category-children-v183{margin-left:8px;padding-left:6px}}
