...
function fitCountBar(bar){
  ...
  const size=Math.max(11.5,Math.min(13.5,appSize-2.5));
...
if(!document.getElementById('pala-calendar-ui-v174-style')){
  ...
  style.textContent=`
    ...
    .calendar-count-summary-v174{display:flex!important;align-items:center!important;justify-content:flex-start!important;gap:4px!important;min-height:30px!important;min-width:0!important;width:100%!important;padding:8px 0 0!important;border-top:1px solid #e4e8ef!important;color:#667085!important;font-size:12px!important;font-weight:750!important;line-height:1!important;flex-wrap:nowrap!important;white-space:nowrap!important;overflow:visible!important}.calendar-count-summary-v174>*{flex:0 0 auto!important;min-width:0!important;white-space:nowrap!important}
