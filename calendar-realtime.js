...
(function(global){
  ...
  function queueReload(){if(reloadQueued)return;reloadQueued=true;setTimeout(async()=>{reloadQueued=false;if(!await reloadCalendar()&&typeof global.scheduleCloudSync==='function')global.scheduleCloudSync();},100);}
  function register(){
